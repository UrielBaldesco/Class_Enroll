...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="display-4 text-center">Edit Student</h2>  
	     ...
	     <input type="hidden" name="id" value="${students.id}"><br><br>
	    	<div class="row g-3 mb-3 mt-3">
			  <div class="col">
			    ...
			    <input type="text" value="${students.name}" name="name" class="form-control" placeholder="First name" aria-label="First name">
			  </div>
			  <div class="col">
			  	<label for="parent" class="form-label">Parent Name</label>
			    <input type="text" value="${students.parent}" name="parent" class="form-control" placeholder="Parent name" aria-label="Parent name">
			  </div>
			</div>
			...
			<div class="row g-3 mb-3">
				<div class="col-12">
			    	...
			    	<input type="text" value="${students.parentEmail}" name="parentEmail" class="form-control" placeholder="Parent Email" aria-label="Parent Email">
			  	</div>
			</div>
			...
			<div class="row g-3 mb-3">
				<div class="col-3">
			    	...
			    	<input type="text" value="${students.age}" name="age" class="form-control" placeholder="Age" aria-label="age">
				</div>
